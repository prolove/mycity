...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'Ir7}]2z_XTLWli.puA8VbC)x@F/S-9qDZ,P|fE<(', //默认数据加密KEY
	'data_cache_key'=> 'Ir7}]2z_XTLWli.puA8VbC)x@F/S-9qDZ,P|fE<(',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'Ir7}]2z_XTLWli.puA8VbC)x@F/S-9qDZ,P|fE<(', //加密KEY
