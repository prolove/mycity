...
-- -----------------------------
-- Records of `twothink_action_log`
-- -----------------------------
INSERT INTO `twothink_action_log` VALUES ('1', '7', '1', '1867134689', 'model', '2', '操作url：/admin/model/updates.html', '1', '1504710267');
INSERT INTO `twothink_action_log` VALUES ('2', '7', '1', '1867134689', 'model', '2', '操作url：/admin/model/updates.html', '1', '1504710507');
INSERT INTO `twothink_action_log` VALUES ('3', '7', '1', '1867134689', 'model', '3', '操作url：/admin/model/updates.html', '1', '1504710533');
INSERT INTO `twothink_action_log` VALUES ('4', '7', '1', '1867134689', 'model', '2', '操作url：/admin/model/updates.html', '1', '1504713038');
INSERT INTO `twothink_action_log` VALUES ('5', '11', '1', '1867134689', 'category', '1', '操作url：/admin/category/updates.html', '1', '1504713670');
INSERT INTO `twothink_action_log` VALUES ('6', '7', '1', '1867134689', 'model', '3', '操作url：/admin/model/updates.html', '1', '1504714159');
INSERT INTO `twothink_action_log` VALUES ('7', '7', '1', '1867134689', 'model', '2', '操作url：/admin/model/updates.html', '1', '1504714171');
INSERT INTO `twothink_action_log` VALUES ('8', '7', '1', '1867134689', 'model', '1', '操作url：/admin/model/updates.html', '1', '1504714179');
...
CREATE TABLE `twothink_addons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='插件表';
...
INSERT INTO `twothink_addons` VALUES ('45', 'sitestat', '站点统计信息', '统计站点的基础信息', '1', '{\"title\":\"\\u7cfb\\u7edf\\u4fe1\\u606f\",\"width\":\"1\",\"display\":\"1\"}', 'thinkphp', '0.1', '1478523840', '0');
...
INSERT INTO `twothink_addons` VALUES ('59', 'returntop', '返回顶部', '回到顶部美化，随机或指定显示，100款样式，每天一种换，天天都用新样式', '1', '{\"random\":\"0\",\"current\":\"16\"}', '小矮人', '0.1', '1504711338', '0');
INSERT INTO `twothink_addons` VALUES ('58', 'webuploader', '百度文件上传', '支持图片文件多文件同时上传', '1', '{\"param\":\"name:docunment;type:pic;number:1;size:2;accept:jpg,gif,png,jpeg\\r\\nname:download;type:pic;number:1;size:2;accept:zip,rar,tar,gz,7z,doc,docx,txt,xml\"}', '小矮人', '0.1', '1504709872', '0');
...
) ENGINE=MyISAM AUTO_INCREMENT=291 DEFAULT CHARSET=utf8 COMMENT='模型属性表';
...
INSERT INTO `twothink_attribute` VALUES ('4', 'category_id', '所属分类', 'int(10) unsigned NOT NULL ', 'string', '', '', '4', ':[cate_id]', '1', '0', '1', '1384508336', '1383891233', '', '3', '', '', '', '3', '');
...
INSERT INTO `twothink_attribute` VALUES ('8', 'model_id', '内容模型ID', 'tinyint(3) unsigned NOT NULL ', 'num', '0', '该文档所对应的模型', '4', ':[model_id]', '1', '0', '1', '1384508350', '1383891233', '', '3', '', '', '', '3', '');
...
INSERT INTO `twothink_attribute` VALUES ('12', 'cover_id', '封面', 'int(10) unsigned NOT NULL ', 'picture', '0', '0-无封面，大于0-封面图片ID，需要函数处理', '1', '', '1', '0', '1', '1384147827', '1383891233', '', '3', '', '', '', '3', '');
...
INSERT INTO `twothink_attribute` VALUES ('290', 'group_id', '所属分组', 'smallint(3) UNSIGNED', 'string', '', '', '4', ':[group_id]', '1', '0', '0', '0', '0', '', '3', '', '', '', '3', '');
...
CREATE TABLE `twothink_document` (
  ...
  `group_id` smallint(3) unsigned DEFAULT NULL COMMENT '所属分组',
...
-- -----------------------------
INSERT INTO `twothink_document` VALUES ('1', '1', '', 'TwoThink2.0正式版', '2', '0', '期待已久的TwoThink最新版发布', '0', '0', '2', '2', '0', '0', '0', '1', '0', '0', '119', '0', '0', '1', '1487091120', '1504710688', '1', '');
...
-- -----------------------------
INSERT INTO `twothink_document_article` VALUES ('1', '0', '<h1>TwoThink2.0正式版<br/></h1><p><br/></p><p><strong>TwoThink是一个开源的内容管理框架,借鉴Onethink系统重构开发的ThinkPHP5.0.10版本开发，提供更方便、更安全的WEB应用开发体验，采用了全新的架构设计和命名空间机制，融合了模块化、驱动化和插件化的设计理念于一体，开启了国内WEB应用傻瓜式开发的新潮流。&nbsp;</strong> </p><h2>主要特性：</h2><p>1. 基于ThinkPHP最新5.0.10版本。</p><p>2. 模块化：全新的架构和模块化的开发机制，便于灵活扩展和二次开发。&nbsp;</p><p>3. 文档模型/分类体系：通过和文档模型绑定，以及不同的文档类型，不同分类可以实现差异化的功能，轻松实现诸如资讯、下载、讨论和图片等功能。</p><p>4. 开源免费：TwoThink遵循Apache2开源协议,免费提供使用。&nbsp;</p><p>5. 用户行为：支持自定义用户行为，可以对单个用户或者群体用户的行为进行记录及分享，为您的运营决策提供有效参考数据。</p><p>6. 云端部署：通过驱动的方式可以轻松支持平台的部署，让您的网站无缝迁移，内置已经支持SAE和BAE3.0。</p><p>7. 云服务支持：即将启动支持云存储、云安全、云过滤和云统计等服务，更多贴心的服务让您的网站更安心。</p><p>8. 安全稳健：提供稳健的安全策略，包括备份恢复、容错、防止恶意攻击登录，网页防篡改等多项安全管理功能，保证系统安全，可靠、稳定的运行。&nbsp;</p><p>9. 应用仓库：官方应用仓库拥有大量来自第三方插件和应用模块、模板主题，有众多来自开源社区的贡献，让您的网站完美无缺。&nbsp;</p><p><br/></p><p><strong>&nbsp;TwoThink集成了一个完善的后台管理体系和前台模板标签系统，让你轻松管理数据和进行前台网站的标签式开发。&nbsp;</strong> </p><p><br/></p><h2>后台主要功能：</h2><p>1. 用户Passport系统</p><p>2. 配置管理系统&nbsp;</p><p>3. 权限控制系统</p><p>4. 后台建模系统&nbsp;</p><p>5. 多级分类系统&nbsp;</p><p>6. 用户行为系统&nbsp;</p><p>7. 钩子和插件系统</p><p>8. 系统日志系统&nbsp;</p><p>9. 数据备份和还原</p><p><br/></p><p><br/></p><p><strong>TwoThink开发团队 2017.2.15</strong> </p>', '', '0');
...
INSERT INTO `twothink_hooks` VALUES ('2', 'pageFooter', '页面footer钩子，一般用于加载插件JS文件和JS代码', '1', '0', '', '1');
INSERT INTO `twothink_hooks` VALUES ('3', 'documentEditForm', '添加编辑表单的 扩展内容钩子', '1', '0', '', '1');
INSERT INTO `twothink_hooks` VALUES ('4', 'documentDetailAfter', '文档末尾显示', '1', '0', '', '1');
...
INSERT INTO `twothink_hooks` VALUES ('17', 'webuploader', '百度图片上传', '1', '1504709872', 'webuploader', '1');
...
CREATE TABLE `twothink_menu` (
  ...
  `icon` varchar(50) NOT NULL DEFAULT '' COMMENT 'icon图标',
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '上级分类ID',
  `sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序（同级有效）',
...
-- -----------------------------
INSERT INTO `twothink_menu` VALUES ('1', '首页', 'glyphicon glyphicon-home', '0', '0', 'Index/index', '0', '', '', '0', '1');
INSERT INTO `twothink_menu` VALUES ('2', '内容', 'glyphicon glyphicon-th-large', '0', '1', 'Article/index', '0', '', '', '0', '1');
...
INSERT INTO `twothink_menu` VALUES ('16', '用户', 'glyphicon glyphicon-user', '0', '2', 'User/index', '0', '', '', '0', '1');
INSERT INTO `twothink_menu` VALUES ('17', '用户信息', 'glyphicon glyphicon-user', '16', '0', 'User/index', '0', '', '用户管理', '0', '1');
...
INSERT INTO `twothink_menu` VALUES ('43', '扩展', 'glyphicon glyphicon-th', '0', '5', 'Addons/index', '0', '', '', '0', '1');
...
INSERT INTO `twothink_menu` VALUES ('68', '系统', 'glyphicon glyphicon-cog', '0', '3', 'Config/group', '0', '', '', '0', '1');
...
INSERT INTO `twothink_menu` VALUES ('93', '其他', '', '0', '4', 'other', '1', '', '', '0', '1');
...
-- -----------------------------
INSERT INTO `twothink_model` VALUES ('1', 'document', '基础文档', '0', '', '1', '{\"1\":[\"2\",\"290\",\"8\",\"4\",\"3\",\"288\",\"5\",\"9\",\"10\",\"11\",\"12\",\"13\",\"14\",\"16\",\"17\",\"19\",\"20\"]}', '1:基础', '', '', '', '', '', 'id:编号\r\ntitle:标题:[EDIT]\r\ntype:类型\r\nupdate_time:最后更新\r\nstatus:状态\r\nview:浏览\r\nid:操作:[EDIT]|编辑,[DELETE]|删除', '0', '', '', '1383891233', '1479651166', '1', 'MyISAM');
INSERT INTO `twothink_model` VALUES ('2', 'article', '文章', '1', '', '1', '{\"1\":[\"290\",\"3\",\"4\",\"8\",\"24\",\"2\",\"288\",\"5\"],\"2\":[\"9\",\"13\",\"19\",\"10\",\"12\",\"16\",\"17\",\"26\",\"20\",\"14\",\"11\",\"25\"]}', '1:基础,2:扩展', '', '', '', '', '', '', '0', '', '', '1383891243', '1479651207', '1', 'MyISAM');
INSERT INTO `twothink_model` VALUES ('3', 'download', '下载', '1', '', '1', '{\"1\":[\"290\",\"3\",\"2\",\"288\",\"5\",\"289\",\"28\",\"30\",\"32\",\"31\"],\"2\":[\"8\",\"4\",\"13\",\"10\",\"9\",\"12\",\"16\",\"17\",\"19\",\"11\",\"20\",\"14\",\"29\"]}', '1:基础,2:扩展', '', '', '', '', '', '', '0', '', '', '1383891252', '1479964263', '1', 'MyISAM');
